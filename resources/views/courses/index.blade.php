        ...
        <main class="container mx-auto px-4 py-10">
            <section class="courses-section">
                ...
                <div class="text-center mb-12">
                    ...
                    <h1 class="text-4xl font-bold text-gray-800">Courses</h1>
                </div>
                        ...
                        <div
                            ...
                            <a href="{{ route('courses.show', $course->id) }}" class="relative">
                                ...
                                <div class="h-48 w-full overflow-hidden">
                                    <img src="{{ asset('courses/assets/img/' . $course->cover_image) }}"
                                        alt="{{ $course->name }}"
                                ...
                                <div
                                    ...
                                    <span class="text-white font-semibold text-lg px-4 py-2 bg-green-600 rounded">View
                                        Course</span>
                                </div>
                                ...
                                @if($course->price > 0)
                                    <span
                                        class="absolute top-3 right-3 bg-yellow-400 text-gray-800 font-bold px-3 py-1 rounded shadow">
                                        ${{ $course->price }}
                                    </span>
                                @else
                            ...
                            <div class="p-4 flex flex-col gap-1">
                                ...
                                <p class="text-gray-500 text-sm truncate">{{ ucfirst($course->level) }} •
                                    {{ $course->language }}
                                </p>

                                <div class="flex justify-between items-center mt-2 text-sm text-gray-500">
                                    <span class="font-medium text-green-600">{{ $course->user->name }}</span>
                                    <span
